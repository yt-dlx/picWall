...
const adUnitId = __DEV__ ? TestIds.REWARDED_INTERSTITIAL : "ca-app-pub-9464475307933754/3867856186";
const adClient = RewardedInterstitialAd.createForAdRequest(adUnitId, { keywords: ["fashion", "clothing"] });

function App() {
  const [hasLoaded, setHasLoaded] = useState(false);
  useEffect(() => {
    const unsubscribeLoaded = adClient.addAdEventListener(RewardedAdEventType.LOADED, () => {
      setHasLoaded(true);
    });
    const unsubscribeEarned = adClient.addAdEventListener(RewardedAdEventType.EARNED_REWARD, (reward) => {
  ...
  return <Button title="Show Rewarded Interstitial Ad" onPress={() => adClient.show()} />;
}
export default App;
// // ============================================================================================
// // ============================================================================================
