...
const adUnitId = __DEV__ ? TestIds.REWARDED_INTERSTITIAL : "ca-app-pub-9464475307933754/6129093997";
const rewardedInterstitial = RewardedInterstitialAd.createForAdRequest(adUnitId, { keywords: ["fashion", "clothing"] });

function App() {
  const [loaded, setLoaded] = useState(false);
  useEffect(() => {
    const unsubscribeLoaded = rewardedInterstitial.addAdEventListener(RewardedAdEventType.LOADED, () => setLoaded(true));
    const unsubscribeEarned = rewardedInterstitial.addAdEventListener(RewardedAdEventType.EARNED_REWARD, (reward) => console.log("User earned reward of ", reward));
