...
const DevMsgModal: React.FC<{ visible: boolean; onClose: () => void }> = ({ visible, onClose }) => {
  const [countdown, setCountdown] = useState(__DEV__ ? 0 : 5);
  const opacity = useSharedValue(0);
  ...
  return (
    <View className="absolute inset-0 justify-center items-center" style={{ zIndex: 1000 }}>
      ...
      <Animated.View className="w-5/5 rounded-3xl p-10 border-4" style={[{ backgroundColor: Colorizer("#0C0C0C", 1.0), borderColor: Colorizer("#FFFFFF", 1.0) }, modalStyle]}>
        <View className="items-center">
          <Text className="mt-2.5 text-4xl" style={{ fontFamily: "Lobster_Regular", color: Colorizer("#FFFFFF", 1.0) }}>
            👋🏻 Hello From Dev Team!
          </Text>
          <Text className="p-4 text-2xl underline" style={{ fontFamily: "Kurale_Regular", color: Colorizer("#FFFFFF", 1.0) }}>
            We Hate Ads (💀) Too !!
          </Text>
          <Text className="p-2 text-xl" style={{ fontFamily: "Kurale_Regular", color: Colorizer("#FFFFFF", 1.0) }}>
          ...
          <TouchableOpacity className="mt-2.5 px-5 py-2 rounded-2xl overflow-hidden" style={{ backgroundColor: Colorizer("#FFFFFF", 1.0) }} onPress={onClose} disabled={countdown > 0}>
            <Text className="text-lg" style={{ fontFamily: "Lobster_Regular", color: Colorizer("#0C0C0C", 1.0) }}>
        ...
        <View className="flex-row h-full overflow-hidden relative">
          ...
          <View className="absolute inset-0 justify-center items-center mt-14">
            ...
            <Animated.View entering={FadeInDown.delay(600).duration(1500).springify()}>
              <View>
                <Text className="text-center" style={{ fontSize: 80, fontFamily: "Lobster_Regular", color: Colorizer("#FFFFFF", 1.0), textShadowColor: Colorizer("#0C0C0C", 1.0) }}>
                  picWall
                </Text>
                <Animated.View style={{ alignSelf: "center" }} entering={FadeInDown.delay(600).duration(1500).springify()}>
                  <View style={{ backgroundColor: Colorizer("#0C0C0C", 0.6), borderRadius: 9999, paddingHorizontal: 12, paddingVertical: 4 }}>
                    <Text style={{ fontFamily: "Lobster_Regular", color: Colorizer("#FFFFFF", 1.0), fontSize: 10, textAlign: "center" }}>
              ...
              <Animated.View entering={FadeIn.delay(1200).duration(1500)} style={{ marginTop: 10, paddingHorizontal: 20, alignItems: "center" }}>
                <Text style={{ fontFamily: "Lobster_Regular", color: Colorizer("#FFFFFF", 0.8), fontSize: 15, textAlign: "center", marginBottom: 4 }}>Personalised AI Wallpapers</Text>
                <Text style={{ fontFamily: "Lobster_Regular", color: Colorizer("#FFFFFF", 0.6), fontSize: 10, textAlign: "center", maxWidth: 300 }}>
